  ...
  return (
    <div className="travel-stats">
      ...
      <div className="stat-box countries">
        ...
        <p className="stats-label">{t('user_stats.countries_visited')}</p>
      </div>
      ...
      <div className="stat-box continents">
        ...
        <p className="stats-label">{t('user_stats.continents_visited')}</p>
      </div>
      ...
      <div className="stat-box travel-goal">
        ...
        <p className="stats-label">{t('user_stats.travel_goal')}</p>
      </div>
      ...
      <div className="stat-box since-box">
        ...
        <p className="stats-label">{t('user_stats.traveling_since')}</p>
      </div>
    </div>
  );
};
